...
eeg_root = '\\blumenfeld1.med.yale.internal\Data7\RNS Study\Subject Raw Data\490KB\Scalp EEG Data\'; 
eeg_folders = {'Calibration and All Runs'};
eeg_files = {'Blumenfeld~ Re_201fdd5d-4474-4620-a017-dad9c99b87c9-archive.lay'};
...
beh_root = {'\\blumenfeld1.med.yale.internal\Data7\RNS Study\Subject Raw Data\490KB\Behavioral Data'};
beh_folders = {'Calibration and All Runs'};
beh_files = {'490KB_Session 1_2019_Jun_12_1422_14.csv'};
...
for session = 1%:length(eeg_folders)
    ...
    save_dir = '\\blumenfeld1.med.yale.internal\Data7\RNS Study\Analysis\Subject Analysis\490KB\Scalp EEG Analysis';
...
%% Find the TTL pulses of interest and ID event onset times
    ...
    %Add TTL onset times (specific for 490KB***)
    onsets  = sort([onsets, 1061949]);
        
    %Add TTL onset times (specific for 490KB***)
    offsets  = sort([offsets, 1061988]);
    
    %Remove TTL onset times that are not face events (specfic for 490KB***)
    bad_TTL_pulse_idx = find(ismember(onsets,[121170,311788,444357,586076,711832,848027,978129,1101550,1226743,1347607]));
