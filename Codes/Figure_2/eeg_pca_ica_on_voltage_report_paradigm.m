...
function [ICA_epochs_components_removed, remove_components] = eeg_pca_ica_on_voltage_report_paradigm(ID, event_type, ICA_epochs, Photo_dir, preprocessed_dir, sampling_rate, num_components, eeglab_prepared_blank)
...
if isequal(event_type,'faces')
    ...
    savefig('faces_epochs_voltage_ICA_components_topoplot.fig')
